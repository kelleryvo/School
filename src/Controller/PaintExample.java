...
public class PaintExample extends JFrame{
	        ...
	        public PaintExample()
	        {
	            ...
	            brushBut = makeMeButtons("./src/img/brush.png", 1);
	            lineBut = makeMeButtons("./src/img/Line.png", 2);
	            ellipseBut = makeMeButtons("./src/img/Ellipse.png", 3);
	            rectBut = makeMeButtons("./src/img/Rectangle.png", 4);
	            
	            // Make all the buttons in makeMeColorButton by passing the
	            // button icon and true for stroke color or false for fill
	            
	            strokeBut = makeMeColorButton("./src/img/Stroke.png", 5, true);
	            fillBut = makeMeColorButton("./src/img/Fill.png", 6, false);
